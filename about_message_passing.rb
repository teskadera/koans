...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # In case the object implements a #send method, the __send__ method remains
    # on the object.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # Interception and redirection - allowing an object to react to an
    # unaticipated call without raising an Error to the client code.
    # Logging might be put in place on it; getters and setters can be built
    # using templated methods; etc.
    #
    # NOTE:
    #
