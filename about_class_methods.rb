...
class AboutClassMethods < Neo::Koan
  ...
  def test_objects_have_methods
    fido = Dog.new
    # Dog objects have 59 methods, by default/inheritance
    assert fido.methods.size > 58
  end

  def test_classes_have_methods
    # Blank Dog class has 104 methods, by default/inheritance
    assert Dog.methods.size > 103
  end

  def test_you_can_define_methods_on_individual_objects
    fido = Dog.new
    # This is *very* strange to me, coming from Java the last couple years.
    def fido.wag
      :fidos_wag
    end
  ...
  def test_class_methods_are_independent_of_instance_methods
    fido = Dog2.new
    # Is this to allow easier implementation of null-object pattern?
